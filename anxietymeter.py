...
class CharacterStatus:
    def __init__(self, image_files, max_health, health_bar_size=(75, 15)):
        # Health attributes
    ...
    def draw(self, surface, icon_pos, health_bar_pos):
        ...
        pygame.draw.rect(surface, 'black', (*health_bar_pos, self.health_bar_width, self.health_bar_height), 2)
        pygame.draw.rect(surface, 'pink', (*health_bar_pos, self.health_bar_width * health_ratio, self.health_bar_height))